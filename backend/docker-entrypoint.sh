...
# Framebuffer kept at 1280x800 (not 1920x1080): fewer pixels = far less to encode and stream,
# which is the dominant source of a "laggy" live view on a remote container. It still
